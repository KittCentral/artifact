...
namespace Voxel
{
    public static class EditTerrain
    {
        ...
        public static bool SetBlock(RaycastHit hit, Block block, bool adjacent = false)
        {
            ...
            WorldPos pos = HittoWorldPos(hit, adjacent);
